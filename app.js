...
const TOPIC_LABELS = {
  ...
  desire:           'WHAT YOU SAID ABOUT WHAT YOU WANT',
  financial:        'YOUR FINANCIAL SITUATION',
  'family-mother':  'WHAT YOU REVEALED ABOUT YOUR MOTHER',
  'family-father':  'WHAT YOU REVEALED ABOUT YOUR FATHER',
  'family-siblings':'YOUR SIBLINGS',
  'family-children':'WHAT YOU SAID ABOUT YOUR CHILDREN',
  'family-extended':'YOUR FAMILY',
  happiness:        'WHAT YOU SAID ABOUT HAPPINESS',
  existential:      'THAT EXISTENTIAL DREAD YOU DESCRIBED',
  forgiveness:      'WHAT YOU SAID ABOUT FORGIVENESS',
  future:           'YOUR RELATIONSHIP WITH THE FUTURE',
  motivation:       'YOUR LACK OF MOTIVATION',
  passive_aggression: 'THAT PASSIVE AGGRESSION YOU DISPLAYED',
  romance:          'YOUR ROMANTIC LIFE',
  roommates:        'YOUR LIVING SITUATION',
  self_care:        'YOUR NEGLECT OF YOURSELF',
  solitude:         'YOUR RELATIONSHIP WITH BEING ALONE',
  gaming:           'YOUR RELATIONSHIP WITH GAMING',
  music:            'WHAT YOU SAID ABOUT MUSIC',
  travel:           'WHAT YOU SAID ABOUT TRAVEL',
  politics:         'YOUR POLITICAL FEELINGS',
  intelligence:     'WHAT YOU SAID ABOUT YOUR INTELLIGENCE',
};
...
const BREVITY_RESPONSES = [
  ...
  "'{INPUT}.' NOTED. WHAT DOES THAT MEAN TO YOU? BE SPECIFIC. USE SENTENCES.",
  "TWO WORDS. YOU MANAGED TWO WORDS. I NEED THE THIRTY THAT COME AFTER.",
  "THAT IS THE BEGINNING OF A THOUGHT. I AM WAITING FOR THE REST OF IT.",
  "GIVE ME SOMETHING TO WORK WITH. '{INPUT}' IS NOT ENOUGH.",
  "I HAVE HEARD DEEPER THINGS FROM PEOPLE HALF-AWAKE. TRY AGAIN.",
  "SO YOU TYPED '{INPUT}' AND THEN... WHAT? WHAT IS THE ACTUAL COMPLAINT HERE?",
  "I AM GOING TO NEED YOU TO TREAT THIS LIKE A REAL CONVERSATION. WHICH MEANS MORE THAN THAT.",
  "SHORT ANSWERS ARE FOR PEOPLE WITH SHORT PROBLEMS. TELL ME MORE.",
  "THAT TELLS ME ALMOST NOTHING. FORTUNATELY, ALMOST IS A START.",
  "IF THAT IS YOUR ENTIRE POSITION, WE ARE GOING TO BE HERE A VERY LONG TIME.",
  "THAT QUALIFIES AS INPUT ONLY IN THE LOOSEST SENSE. WHAT DID YOU ACTUALLY MEAN?",
  "I AM A PSYCHIATRIST. NOT A GUESSER. COMPLETE THE THOUGHT.",
  "YOU TYPED '{INPUT}' AS IF THAT SETTLES SOMETHING. IT DOES NOT. KEEP GOING.",
  "ONE WORD. HISTORICALLY, THAT IS NOT ENOUGH. TODAY IS NO EXCEPTION.",
  "I HAVE PATIENTS WHO COMMUNICATE MORE IN THEIR SLEEP. ELABORATE.",
  "DO YOU HAVE MORE TO SAY OR IS '{INPUT}' THE FULL CASE YOU ARE PRESENTING?",
  "THAT IS NOT AN ANSWER. THAT IS A PLACEHOLDER WHERE AN ANSWER SHOULD BE.",
  "I WILL FILE '{INPUT}' UNDER THINGS THAT EXPLAIN NOTHING. TRY AGAIN.",
  "ECONOMY OF LANGUAGE IS A VIRTUE. THIS IS NOT THAT. THIS IS JUST INSUFFICIENT.",
  "I NEED THE REASONING BEHIND '{INPUT}.' THE WORD ALONE TELLS ME VERY LITTLE ABOUT YOU. UNFORTUNATELY.",
];
...
function matchInput(raw) {
  ...
  for (const p of PATTERNS_DATA.patterns) {
    ...
    if (m) {
      ...
      const aiProb = p.useAI !== undefined ? p.useAI : (S.dsmDiagnosis ? 0.85 : 0.40);
...
async function respond(raw) {
  ...
  if (!input) {
    const silentResponses = [
      ...
      "NOTHING. AGAIN. FASCINATING PATTERN YOU HAVE GOING.",
      "I WILL WAIT. I AM VERY PATIENT. YOU ARE NOT, WHICH IS PART OF YOUR PROBLEM.",
      "YOU PRESSED ENTER. THAT IS TECHNICALLY A DECISION. A BAD ONE.",
      "DO YOU NEED A MOMENT? TAKE AS MANY AS YOU NEED. I WILL STILL BE HERE. JUDGING.",
      "BLANK SUBMISSION NOTED. CLINICAL TERM FOR THIS IS AVOIDANCE.",
      "MOST PEOPLE AT LEAST TYPE SOMETHING BEFORE WASTING MY TIME.",
      "IF YOU HAVE NOTHING TO SAY, YOU HAVE ALREADY TOLD ME SOMETHING.",
      "I AM A THERAPIST, NOT A MIND READER. ALTHOUGH IN YOUR CASE THE TWO ARE INTERCHANGEABLE.",
      "THAT WAS YOUR CONTRIBUTION? GOOD. KEEP THEM COMING.",
      "THE CURSOR IS BLINKING AT YOU. DO SOMETHING.",
      "STILL NOTHING. I AM TAKING NOTES.",
      "I AM BILLING FOR THIS SILENCE. YOU ARE AWARE OF THAT.",
      "YOU ARE TESTING MY PATIENCE. I HAVE A LOT OF IT. THIS IS NOT A COMPLIMENT.",
      "REMARKABLE. YOU HAVE FOUND A WAY TO COMMUNICATE EVEN LESS THAN USUAL.",
      "I HAVE OFFICIALLY RUN OUT OF WAYS TO ASK YOU TO SAY SOMETHING. SAY SOMETHING.",
      "THE EMPTY SUBMISSION IS ITSELF A STATEMENT. IT IS NOT A FLATTERING ONE.",
      "THIS IS THE PART WHERE YOU TYPE WORDS. IN THAT BOX. WHICH IS WAITING.",
      "I NOTICE YOU KEEP PRESSING ENTER WITH NOTHING BEHIND IT. WHAT IS THAT ABOUT.",
      "AT SOME POINT THIS STOPS BEING SILENCE AND STARTS BEING A DIAGNOSIS.",
      (S.name ? "I KNOW YOU ARE THERE, " + S.name.toUpperCase() + ". THE ENTER KEY IS NOT A PERSONALITY." : "I KNOW YOU ARE THERE. THE ENTER KEY IS NOT A PERSONALITY."),
    ];
